...
function Projects() {
    ...
    return (
        <Layout>
            <h2 className="gradient-text mt-[10px] px-10 text-center text-xl font-semibold">
                ...
                {translations?.[language]?.projects?.items?.map((data, index) => {
                    ...
                    return (
                        ...
                        >
                            ...
                            <div
                                className={`relative ${data.scroll == 'true' ? 'scroll-preview' : 'h-[250px] w-full'} `}
                            >
                            ...
                            <div className="w-full px-5 text-left">
                                <h2 className="mb-2 whitespace-nowrap text-center text-xl font-bold">{data.title}</h2>
